...
public class TesteReferencia {
	public static void main(String[] args) {
		...
		System.out.println("Após depositivar (Primeira Conta)" + segundaConta.saldo);
		
		
		//sacar
		segundaConta.sacar(1);
		System.out.println("Após sacar (Primeira Conta)" + segundaConta.saldo);
		System.out.println("O valor da terceira " + terceiraConta.saldo);
		
		
		//transferir
		segundaConta.transfere(400, terceiraConta);
		System.out.println(" A segnda conta após transferir ficou com: " + segundaConta.saldo);
		} 
